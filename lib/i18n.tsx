...
const en: Dict = {
  ...
  "fs.flexDates": "Flexible dates (± 3 days)",
...
const es: Dict = {
  ...
  "fs.flexDates": "Fechas flexibles (± 3 días)",
...
const fr: Dict = {
  ...
  "fs.flexDates": "Dates flexibles (± 3 jours)",
...
const ar: Dict = {
  ...
  "fs.flexDates": "تواريخ مرنة (± ٣ أيام)",
...
const ur: Dict = {
  ...
  "fs.flexDates": "لچکدار تاریخیں (± ۳ دن)",
