...
const en: Dict = {
  ...
  "nav.about": "About",
  "nav.contact": "Contact",
  "cta.findDeals": "Find Flights",
  "cta.searchDeals": "Search Flights",
  "hero.badge": "Trusted airline tickets at the best fares",
  "hero.title": "Book trusted airline tickets at the best fares —",
  "hero.accent": "flights, hotels & car rentals",
  "hero.subline":
...
const es: Dict = {
  ...
  "cta.findDeals": "Buscar vuelos",
  "cta.searchDeals": "Buscar vuelos",
  "hero.badge": "Billetes de aerolíneas de confianza a las mejores tarifas",
  "hero.title": "Reserva billetes de aerolíneas de confianza a las mejores tarifas —",
  "hero.accent": "vuelos, hoteles y coches",
  "hero.subline":
...
const fr: Dict = {
  ...
  "nav.about": "À propos",
  "nav.contact": "Contact",
  "cta.findDeals": "Trouver des vols",
  "cta.searchDeals": "Rechercher des vols",
  "hero.badge": "Billets d'avion de confiance aux meilleurs tarifs",
  "hero.title": "Réservez des billets d'avion de confiance aux meilleurs tarifs —",
  "hero.accent": "vols, hôtels et voitures",
  "hero.subline":
...
const ar: Dict = {
  ...
  "cta.findDeals": "ابحث عن رحلات",
  "cta.searchDeals": "ابحث عن رحلات",
  "hero.badge": "تذاكر طيران موثوقة بأفضل الأسعار",
  "hero.title": "احجز تذاكر طيران موثوقة بأفضل الأسعار —",
  "hero.accent": "رحلات وفنادق وسيارات",
  "hero.subline":
...
const ur: Dict = {
  ...
  "nav.contact": "رابطہ",
  "cta.findDeals": "پروازیں تلاش کریں",
  "cta.searchDeals": "پروازیں تلاش کریں",
  "hero.badge": "بھروسہ مند ایئر لائن ٹکٹ بہترین کرایوں پر",
  "hero.title": "بھروسہ مند ایئر لائن ٹکٹ بہترین کرایوں پر بُک کریں —",
  "hero.accent": "پروازیں، ہوٹل اور گاڑیاں",
  "hero.subline":
