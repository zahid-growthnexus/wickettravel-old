...
export default function Hero() {
  ...
  return (
    ...
    <section
      id="top"
      className="relative isolate overflow-hidden pb-[326px] pt-28 sm:pb-[259px] sm:pt-32 lg:pb-[190px] lg:pt-36"
    >
    ...
    <div className="hero-rise hero-rise-4 container-page relative z-raised -mt-[302px] sm:-mt-[235px] lg:-mt-[166px]">
      <FlightSearch />
    </div>
    </>
  );
