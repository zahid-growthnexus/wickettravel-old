  ...
  return (
    <section id="newsletter" className="section scroll-mt-16 bg-sand-500">
      <div className="container-page">
        {/* The box was `bg-primary-800` with a full-bleed absolutely-positioned
            gradient laid over it — from-primary-800 via-primary-800
            to-primary-900, i.e. an extra painted layer to tint one corner of a
            flat navy panel. The overlay div is gone; the panel's own token
            background does the job. */}
        <div className="relative overflow-hidden rounded-lg bg-primary-800 px-6 py-12 shadow-e3 sm:px-12 sm:py-16">
          <div className="relative mx-auto max-w-2xl text-center">
            ...
            <p className="t-body-lg mx-auto mt-4 max-w-xl text-primary-100">
              {t("news.lead")}
            </p>
